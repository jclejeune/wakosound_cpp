...
Pool de 1024 voix audio fixes. Zéro allocation dans le callback PortAudio.
...
Démarre une voix. Voice stealing si toutes les 1024 voix sont occupées.
...
#### `bool init(int sampleRate = 44100, int framesPerBuffer = 1024)`
